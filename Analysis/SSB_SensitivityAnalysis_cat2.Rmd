...
# Set up education stratified variables
  ...
  with(no_hs, table(ssb_cat2_high, sleep_01))
  with(no_hs, table(ssb_cat2_low, sleep_01))
  
  with(hs, table(ssb_cat2_high, sleep_01))
  with(hs, table(ssb_cat2_low, sleep_01))
  
  with(some_coll, table(ssb_cat2_high, sleep_01))
  with(some_coll, table(ssb_cat2_low, sleep_01))
  
  with(coll, table(ssb_cat2_high, sleep_01))
  with(coll, table(ssb_cat2_low, sleep_01))
