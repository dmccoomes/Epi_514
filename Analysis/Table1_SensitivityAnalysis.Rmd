...
table1_sensitivity_cat2 <- stargazer(tables, summary=FALSE, rownames=TRUE, type="html", 
              title = "Table 1. Descriptive statistics of sample by average daily SSB consumption - Sensitivity Analysis.(n = 85,760)",
              align=TRUE,
              style="ajs",
